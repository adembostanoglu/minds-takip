// V1.17.3 — Mesai detay tablosu: sadece CSS, yatay kaydırma yok; ek event/observer yok.
(function bootAttendanceFullWidthTableV173(){
  if(window.__mindsAttendanceFullWidthTableV173)return;
  window.__mindsAttendanceFullWidthTableV173=true;

  const style=document.createElement('style');
  style.id='attFullWidthTableV173Style';
  style.textContent=`
    ...
    .att-drawer-v166 .att-drawer-table-v166 th:nth-child(7){font-size:0!important}
    .att-drawer-v166 .att-drawer-table-v166 th:nth-child(7)::after{content:'Mesai Durumu';font-size:9px!important}
    @media(max-width:900px){
      ...
      .att-drawer-v166 .att-drawer-table-v166 th:nth-child(7)::after{font-size:8px!important}
    }
  `;
