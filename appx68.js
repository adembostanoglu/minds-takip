...
(function bootMobileShellV220(){
  ...
  function installStyles(){
    ...
    s.textContent=`
      #mobileNavV220,#mobileMenuOverlayV220,#mobileMenuCloseV220,#mobileMenuBtnV220{display:none}
      @media(max-width:760px){
        ...
        /* Off-canvas full navigation: desktop sidebar itself is reused, no duplicate menu state. */
        ...
        .sidebar nav{display:flex!important;grid-template-columns:none!important;flex:1;gap:4px;padding:14px 12px 18px!important;overflow:auto;overscroll-behavior:contain}
        ...
        .profile-box{display:flex!important;padding:14px 16px calc(14px + env(safe-area-inset-bottom))!important;background:#0d1316}
        ...
        /* Dashboard and generic content density. */
        ...
        /* Tables remain full fidelity, but behave as a deliberate horizontal data surface. */
        ...
        /* Mobile forms / modals become bottom sheets. */
        ...
        /* Existing notification panel fits beneath sticky mobile header. */
        ...
        /* New monitoring modules stay readable without turning into tiny desktop cards. */
        ...
        /* Login also gets phone-sized spacing. */
  ...
  function ensureUi(){
    ...
    if(!menuBtn){
      menuBtn=document.createElement('button');menuBtn.type='button';menuBtn.id='mobileMenuBtnV220';menuBtn.setAttribute('aria-label','Menüyü aç');menuBtn.textContent='☰';
      topbar.insertBefore(menuBtn,topbar.firstChild);
    }

    let closeBtn=document.getElementById('mobileMenuCloseV220');
    if(!closeBtn){
      closeBtn=document.createElement('button');closeBtn.type='button';closeBtn.id='mobileMenuCloseV220';closeBtn.setAttribute('aria-label','Menüyü kapat');closeBtn.textContent='×';sidebar.appendChild(closeBtn);
    }
