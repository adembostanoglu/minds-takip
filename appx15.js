...
if(!document.querySelector('script[data-minds-v140-performance]')){const s=document.createElement('script');s.src='appx27.js?v=1400';s.dataset.mindsV140Performance='1';s.onerror=()=>console.error('V1.14 fair performance module could not be loaded');document.body.appendChild(s);}
