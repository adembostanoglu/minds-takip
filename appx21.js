// V1.17.3 loader bridge — stable bootstrap + share sync + attendance modules + package-based firm completion + social media tracking + CSS-only full-width attendance detail table.
(function loadStableLayersV173(){
  ...
  load('data-minds-v173-attendance-fullwidth-table','appx40.js?v=1730','V1.17.3 attendance full-width table module could not be loaded');
})();
