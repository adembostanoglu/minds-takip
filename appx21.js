// V1.19.2 loader bridge — stable bootstrap + attendance/payroll + grouped activity/extras + Saturday, manual overtime, fair Sunday weekly-rest workflow + visible completed-day state + staff agenda firm names + role/person device access policy + attendance day management + numbered staff order + inline expandable personnel details + overtime work notes.
(function loadStableLayersV192(){
  ...
  load('data-minds-v191-attendance-inline-details','appx53.js?v=1910','V1.19.1 inline attendance details module could not be loaded');
