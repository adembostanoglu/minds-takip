// V1.19.0 loader bridge — stable bootstrap + attendance/payroll + grouped activity/extras + Saturday, manual overtime, fair Sunday weekly-rest workflow + visible completed-day state + staff agenda firm names + role/person device access policy + attendance day management + fixed numbered staff order.
(function loadStableLayersV190(){
  ...
  load('data-minds-v190-attendance-staff-order','appx52.js?v=1900','V1.19.0 attendance staff order module could not be loaded');
