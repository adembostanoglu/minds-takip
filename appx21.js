// V1.16.1 loader bridge — stable bootstrap + target summary + weighted extras + carryover + shoot notes + performance + external shoots + prepared highlight + agenda + attendance/payroll + account security.
(function loadStableLayersV161(){
